=== Custom Variables ===
Contributors: Allen Li
Donate link: http://www.easymode.com.au/#custom-variables
Tags: custom, variable, option, setting, global
...
1. Add variables on the Settings > Custom Variables page.
...
<pre>echo do_shortcode('put_your_shortcode_here');</pre> in your php files.
